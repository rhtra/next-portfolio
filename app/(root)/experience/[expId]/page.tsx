...
const getDate = (date: Date): string => {
  ...
  const month = monthsShort[date.getMonth()]; // "Sep"
...
const getDurationText = (
  ...
  const startYear = getDate(startDate);
  const endYear =
    typeof endDate === "string" ? "Present" : getDate(endDate);
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="flex justify-center sm:justify-end">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap bg-primary/10 text-primary border border-primary/20">
                      {getDurationText(
